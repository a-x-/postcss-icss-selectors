  ...
  var newNodes = node.nodes.reduce(function(acc, n, index, nodes) {
    switch (n.type) {
      ...
      case "class":
        if (mode === "local") {
          return [].concat(_toConsumableArray(acc), [
            Object.assign({}, n, { name: getAlias(n.name) })
          ]);
        }
        return [].concat(_toConsumableArray(acc), [n]);
...
var localizeSelectors = function localizeSelectors(selectors, mode, getAlias) {
  ...
  return _cssSelectorTokenizer2.default.stringify(
    Object.assign({}, node, {
...
module.exports = _postcss2.default.plugin(plugin, function() {
  ...
  return function(css, result) {
    ...
    var generateScopedName =
      options.generateScopedName ||
      (0, _genericNames2.default)("[name]__[local]---[hash:base64:5]");
    ...
    (_result$messages = result.messages).push.apply(
      _result$messages,
      _toConsumableArray(getMessages(aliases))
    );
    // contracts
